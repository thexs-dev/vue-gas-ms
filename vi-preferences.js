    ...
    <v-container pa-2 fluid>
      ...
      <div v-show="selected === 'layers'">
        ...
        <v-layout v-if="uidata.layerDataFileAvailable || itsme">
          ...
          <v-select class="mr-3" :items="'GeoJSON,Kml/Kmz'.split(',')" v-model="settings.layers.datafile.type" :disabled="!settings.layers.datafile.enabled" :label="localize('Type')"></v-select>
