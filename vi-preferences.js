...
<div>
  <v-toolbar app>
    <v-menu open-on-hover>
      ...
      <v-list xdense>
        <v-list-tile xstyle="height:40px;" v-for="item in 'general,document,filters,map,infowindow,listing,routing,layers'.split(',').concat(uidata.extendedAvailable ? 'extend' : [])" @click="selected = item">
