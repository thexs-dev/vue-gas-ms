    ...
    <v-container fluid>
      <v-layout ma-3>
        <v-flex xs6 mr-2>
          ...
          <div>{{localize('subscribe-contribution')}}: {{subscription.current.mc_gross ? (subscription.current.mc_gross*1).toFixed() : 25}} USD / {{localize(subscription.current.period)}}</div>
