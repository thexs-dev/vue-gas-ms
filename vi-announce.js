...
import VxMarked from 'https://cdn.jsdelivr.net/gh/thexs-dev/vue-gas-ms@0.7.5/vx-marked.js';
...
<div>
  <v-app-bar app>
    ...
    <v-icon @click="window.open('http://addon.thexs.ca/mapping-sheets'); $gae('review');" :title="$localize('my-review')">mdi-star</v-icon>
